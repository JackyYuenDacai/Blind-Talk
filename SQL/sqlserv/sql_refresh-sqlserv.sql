...
create table share_recs(id varchar(64),sh_type int not null,priv int not null,val varchar(max) not null,sh_time datetime default getdate(),enum int);
...
create table user_description(id varchar(64) primary key,des varchar(max));
...
create table user_icon(id varchar(64) primary key,icpath varchar(max) default 'defser.png');
--share_recs.sh_type
--0:img
--1:vid
--2:text
